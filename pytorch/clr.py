...
class CyclicLR(object):
    ...
    def __init__(self, optimizer, base_lr=1e-3, max_lr=6e-3,
                ...
                decay_cycle=None, decay_gamma=None):
    ...
    def get_lr(self):
        ...
        if self.decay_cycle and self.decay_gamma:
            times = (1 + self.last_batch_iteration) / ((2 * step_size) * self.decay_cycle)
            decay = self.decay_gamma ** times
